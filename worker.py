...
#service.Inkscape_Path_Click(None)
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        print(f"error decoding: {body.decode()}")
    ...
    elif cmd == "menu_File_Open_Design":
        #upload file first?
        service.menu_File_Open_Design("tempfile")
