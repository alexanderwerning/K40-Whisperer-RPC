...
try:
    ...
    pass
try:
    from PIL import ImageTk, _imaging
except:
...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        self.PreviewCanvas.tag_bind(
            'LaserTag', "<ButtonRelease-1>", self.mousePanStop)

        self.PreviewCanvas.tag_bind(
            'LaserDot', "<3>", self.right_mousePanStart)
        self.PreviewCanvas.tag_bind(
            'LaserDot', "<B3-Motion>", self.right_mousePan)
        self.PreviewCanvas.tag_bind(
            'LaserDot', "<ButtonRelease-3>", self.right_mousePanStop)
        ...
        self.Label_Reng_feed_u = Label(
            self.master, textvariable=self.funits, anchor=W)
        self.Entry_Reng_feed = Entry(self.master, width="15")
        self.Entry_Reng_feed.configure(
            textvariable=self.Reng_feed, justify='center', fg="black")
        self.Reng_feed.trace_variable("w", self.Entry_Reng_feed_Callback)
        self.NormalColor = self.Entry_Reng_feed.cget('bg')

        self.Label_Veng_feed_u = Label(
            self.master, textvariable=self.funits, anchor=W)
        self.Entry_Veng_feed = Entry(self.master, width="15")
        self.Entry_Veng_feed.configure(
            textvariable=self.Veng_feed, justify='center', fg="blue")
        self.Veng_feed.trace_variable("w", self.Entry_Veng_feed_Callback)
        self.NormalColor = self.Entry_Veng_feed.cget('bg')

        self.Label_Vcut_feed_u = Label(
            self.master, textvariable=self.funits, anchor=W)
        self.Entry_Vcut_feed = Entry(self.master, width="15")
        self.Entry_Vcut_feed.configure(
            textvariable=self.Vcut_feed, justify='center', fg="red")
        self.Vcut_feed.trace_variable("w", self.Entry_Vcut_feed_Callback)
        self.NormalColor = self.Entry_Vcut_feed.cget('bg')

        # Buttons
        self.Reng_Button = Button(
            self.master, text="Raster Engrave", command=self.Raster_Eng)
        self.Veng_Button = Button(
            self.master, text="Vector Engrave", command=self.Vector_Eng)
        self.Vcut_Button = Button(
            self.master, text="Vector Cut", command=self.Vector_Cut)
        self.Grun_Button = Button(
            self.master, text="Run G-Code", command=self.Gcode_Cut)
        ...
        self.Reng_Veng_Vcut_Button = Button(
            self.master, text="Raster Engrave\nVector Engrave\nand\nVector Cut", command=self.Raster_Vector_Cut)

        self.Label_Position_Control = Label(
            self.master, text="Position Controls:", anchor=W)
        ...
        self.Home_Button = Button(
            self.master, text="Home",            command=self.Home)
        self.UnLock_Button = Button(
            self.master, text="Unlock Rail",     command=self.Unlock)
        self.Stop_Button = Button(
            self.master, text="Pause/Stop",      command=self.Stop)

        try:
            self.left_image = self.Imaging_Free(
                Image.open(Path("icons/left.png")), bg=None)
            self.right_image = self.Imaging_Free(
                Image.open(Path("icons/right.png")), bg=None)
            self.up_image = self.Imaging_Free(
                Image.open(Path("icons/up.png")), bg=None)
            self.down_image = self.Imaging_Free(
                Image.open(Path("icons/down.png")), bg=None)

            self.Right_Button = Button(
                self.master, image=self.right_image, command=self.Move_Right)
            self.Left_Button = Button(
                self.master, image=self.left_image,  command=self.Move_Left)
            self.Up_Button = Button(
                self.master, image=self.up_image,    command=self.Move_Up)
            self.Down_Button = Button(
                self.master, image=self.down_image,  command=self.Move_Down)

            self.UL_image = self.Imaging_Free(
                Image.open(Path("icons/UL.png")), bg=None)
            self.UC_image = self.Imaging_Free(
                Image.open(Path("icons/UC.png")), bg=None)
            self.UR_image = self.Imaging_Free(
                Image.open(Path("icons/UR.png")), bg=None)
            self.CL_image = self.Imaging_Free(
                Image.open(Path("icons/CL.png")), bg=None)
            self.CC_image = self.Imaging_Free(
                Image.open(Path("icons/CC.png")), bg=None)
            self.CR_image = self.Imaging_Free(
                Image.open(Path("icons/CR.png")), bg=None)
            self.LL_image = self.Imaging_Free(
                Image.open(Path("icons/LL.png")), bg=None)
            self.LC_image = self.Imaging_Free(
                Image.open(Path("icons/LC.png")), bg=None)
            self.LR_image = self.Imaging_Free(
                Image.open(Path("icons/LR.png")), bg=None)

            self.UL_Button = Button(
                self.master, image=self.UL_image, command=self.Move_UL)
            self.UC_Button = Button(
                self.master, image=self.UM_image, command=self.Move_UC)
            self.UR_Button = Button(
                self.master, image=self.UR_image, command=self.Move_UR)
            self.CL_Button = Button(
                self.master, image=self.CL_image, command=self.Move_CL)
            self.CC_Button = Button(
                self.master, image=self.CC_image, command=self.Move_CC)
            self.CR_Button = Button(
                self.master, image=self.CR_image, command=self.Move_CR)
            self.LR_Button = Button(
                self.master, image=self.LR_image, command=self.Move_LR)
            self.LL_Button = Button(
                self.master, image=self.LL_image, command=self.Move_LL)
            self.LC_Button = Button(
                self.master, image=self.LM_image, command=self.Move_LC)

        except:
            self.Right_Button = Button(
                self.master, text=">",          command=self.Move_Right)
            self.Left_Button = Button(
                self.master, text="<",          command=self.Move_Left)
            self.Up_Button = Button(
                self.master, text="^",          command=self.Move_Up)
            self.Down_Button = Button(
                self.master, text="v",          command=self.Move_Down)

            self.UL_Button = Button(
                self.master, text="┌", command=self.Move_UL)
            self.UC_Button = Button(
                self.master, text="┬", command=self.Move_UC)
            self.UR_Button = Button(
                self.master, text="┐", command=self.Move_UR)
            self.CL_Button = Button(
                self.master, text="├", command=self.Move_CL)
            self.CC_Button = Button(
                self.master, text="┼", command=self.Move_CC)
            self.CR_Button = Button(
                self.master, text="┤", command=self.Move_CR)
            self.LL_Button = Button(
                self.master, text="└", command=self.Move_LL)
            self.LC_Button = Button(
                self.master, text="┴", command=self.Move_LC)
            self.LR_Button = Button(
                self.master, text="┘", command=self.Move_LR)

        self.Label_Step = Label(self.master, text="Jog Step", anchor=CENTER)
        self.Label_Step_u = Label(
        ...
        self.GoTo_Button = Button(
            self.master, text="Move To", command=self.GoTo)
        ...
        self.Label_Advanced_column = Label(
            self.master, text="Advanced Settings", anchor=CENTER)
        ...
        self.Checkbutton_Halftone_adv = Checkbutton(
        ...
        self.Checkbutton_Negate_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Checkbutton_Mirror_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Checkbutton_Rotate_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Checkbutton_inputCSYS_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        self.Checkbutton_inputCSYS_adv.configure(variable=self.inputCSYS)
        self.inputCSYS.trace_variable(
        ...
        self.Entry_Design_Scale.configure(
            textvariable=self.design_scale, justify='center', fg="black")
        self.design_scale.trace_variable("w", self.Entry_Design_Scale_Callback)
        self.NormalColor = self.Entry_Design_Scale.cget('bg')

        self.Label_Inside_First_adv = Label(
            self.master, text="Cut Inside First")
        self.Checkbutton_Inside_First_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Label_Rotary_Enable_adv = Label(
            self.master, text="Use Rotary Settings")
        ...
        self.Label_Comb_Engrave_adv = Label(
            self.master, text="Group Engrave Tasks")
        self.Checkbutton_Comb_Engrave_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Label_Comb_Vector_adv = Label(
            self.master, text="Group Vector Tasks")
        self.Checkbutton_Comb_Vector_adv = Checkbutton(
            self.master, text=" ", anchor=W)
        ...
        self.Entry_Veng_passes.configure(
            textvariable=self.Veng_passes, justify='center', fg="blue")
        ...
        self.Entry_Vcut_passes.configure(
            textvariable=self.Vcut_passes, justify='center', fg="red")
        ...
        self.Hide_Adv_Button = Button(
            self.master, text="Hide Advanced", command=self.Hide_Advanced)
        ...
        top_File.add("command", label="Save Settings File",
                     command=self.menu_File_Save)
        top_File.add("command", label="Read Settings File",
                     command=self.menu_File_Open_Settings_File)

        top_File.add_separator()
        top_File.add("command", label="Open Design (SVG/DXF/G-Code)",
                     command=self.menu_File_Open_Design)
        top_File.add("command", label="Reload Design",
                     command=self.menu_Reload_Design)

        top_File.add_separator()
        top_File.add("command", label="Send EGV File to Laser",
                     command=self.menu_File_Open_EGV)

        SaveEGVmenu = Menu(self.master, relief="raised", bd=2, tearoff=0)
        top_File.add_cascade(label="Save EGV File", menu=SaveEGVmenu)
        SaveEGVmenu.add("command", label="Raster Engrave",
                        command=self.menu_File_Raster_Engrave)
        SaveEGVmenu.add("command", label="Vector Engrave",
                        command=self.menu_File_Vector_Engrave)
        SaveEGVmenu.add("command", label="Vector Cut",
                        command=self.menu_File_Vector_Cut)
        SaveEGVmenu.add("command", label="G-Code Operations",
                        command=self.menu_File_G_Code)
        SaveEGVmenu.add_separator()
        SaveEGVmenu.add("command", label="Raster and Vector Engrave",
                        command=self.menu_File_Raster_Vector_Engrave)
        SaveEGVmenu.add("command", label="Vector Engrave and Cut",
                        command=self.menu_File_Vector_Engrave_Cut)
        SaveEGVmenu.add("command", label="Raster, Vector Engrave and Vector Cut",
        ...
        top_View.add("command", label="Refresh   <F5>",
        ...
        if DEBUG:
            top_View.add_checkbutton(
                label="Show Raster Paths", variable=self.include_Rpth, command=self.menu_View_Refresh)

        top_View.add_checkbutton(label="Show Vector Engrave",
                                 variable=self.include_Veng, command=self.menu_View_Refresh)
        top_View.add_checkbutton(
        ...
        top_View.add_separator()
        top_View.add_checkbutton(label="Show Time Estimates",
                                 variable=self.include_Time, command=self.menu_View_Refresh)
        top_View.add_checkbutton(label="Zoom to Design Size",
        ...
        top_Tools.add("command", label="Calculate Raster Time",
                      command=self.menu_Calc_Raster_Time)
        top_Tools.add("command", label="Trace Design Boundary <Ctrl-t>",
                      command=self.TRACE_Settings_Window)
        top_Tools.add_separator()
        top_Tools.add("command", label="Initialize Laser <Ctrl-i>",
        ...
        top_Settings.add("command", label="General Settings <F2>",
                         command=self.GEN_Settings_Window)
        top_Settings.add("command", label="Raster Settings <F3>",
                         command=self.RASTER_Settings_Window)
        top_Settings.add("command", label="Rotary Settings <F4>",
                         command=self.ROTARY_Settings_Window)
        ...
        top_Help.add("command", label="About (e-mail)",
                     command=self.menu_Help_About)
        top_Help.add("command", label="K40 Whisperer Web Page",
                     command=self.menu_Help_Web)
        top_Help.add("command", label="Manual (Web Page)",
                     command=self.menu_Help_Manual)
...
################################################################################
    ...
    def WriteConfig(self):
        ...
        header.append(
            "(=========================================================)")
        # BOOL
        header.append(f'(k40_whisperer_set include_Reng  {int(self.include_Reng.get())} )')
        header.append(f'(k40_whisperer_set include_Veng  {int(self.include_Veng.get())} )')
        header.append(f'(k40_whisperer_set include_Vcut  {int(self.include_Vcut.get())} )')
        header.append(f'(k40_whisperer_set include_Gcde  {int(self.include_Gcde.get())} )')
        header.append(f'(k40_whisperer_set include_Time  {int(self.include_Time.get())} )')
        header.append(f'(k40_whisperer_set halftone      {int(self.halftone.get())} )')
        header.append(f'(k40_whisperer_set HomeUR        {int(self.HomeUR.get())} )')
        header.append(f'(k40_whisperer_set inputCSYS     {int(self.inputCSYS.get())} )')
        header.append(f'(k40_whisperer_set advanced      {int(self.advanced.get())} )')
        header.append(f'(k40_whisperer_set mirror        {int(self.mirror.get())} )')
        header.append(f'(k40_whisperer_set rotate        {int(self.rotate.get())} )')
        header.append(f'(k40_whisperer_set negate        {int(self.negate.get())} )')
        header.append(f'(k40_whisperer_set engraveUP     {int(self.engraveUP.get())} )')
        header.append(f'(k40_whisperer_set init_home     {int(self.init_home.get())} )')
        header.append(f'(k40_whisperer_set post_home     {int(self.post_home.get())} )')
        header.append(f'(k40_whisperer_set post_beep     {int(self.post_beep.get())} )')
        header.append(f'(k40_whisperer_set post_disp     {int(self.post_disp.get())} )')
        header.append(f'(k40_whisperer_set post_exec     {int(self.post_exec.get())} )')
        header.append(f'(k40_whisperer_set pre_pr_crc    {int(self.pre_pr_crc.get())} )')
        header.append(f'(k40_whisperer_set inside_first  {int(self.inside_first.get())} )')
        header.append(f'(k40_whisperer_set comb_engrave  {int(self.comb_engrave.get())} )')
        header.append(f'(k40_whisperer_set comb_vector   {int(self.comb_vector.get())} )')
        header.append(f'(k40_whisperer_set zoom2image    {int(self.zoom2image.get())} )')
        header.append(f'(k40_whisperer_set rotary        {int(self.rotary.get())} )')
        header.append(f'(k40_whisperer_set trace_w_laser {int(self.trace_w_laser.get())} )')
        header.append(f'(k40_whisperer_set board_name    {self.board_name.get()} )')
        header.append(f'(k40_whisperer_set units         {self.units.get()} )')
        header.append(f'(k40_whisperer_set Reng_feed     {self.Reng_feed.get()} )')
        header.append(f'(k40_whisperer_set Veng_feed     {self.Veng_feed.get()} )')
        header.append(f'(k40_whisperer_set Vcut_feed     {self.Vcut_feed.get()} )')
        header.append(f'(k40_whisperer_set jog_step      {self.jog_step.get()} )')
        header.append(f'(k40_whisperer_set Reng_passes   {self.Reng_passes.get()} )')
        header.append(f'(k40_whisperer_set Veng_passes   {self.Veng_passes.get()} )')
        header.append(f'(k40_whisperer_set Vcut_passes   {self.Vcut_passes.get()} )')
        header.append(f'(k40_whisperer_set Gcde_passes   {self.Gcde_passes.get()} )')
        header.append(f'(k40_whisperer_set rast_step     {self.rast_step.get()} )')
        header.append(f'(k40_whisperer_set ht_size       {self.ht_size.get()} )')
        header.append(f'(k40_whisperer_set LaserXsize    {self.LaserXsize.get()} )')
        header.append(f'(k40_whisperer_set LaserYsize    {self.LaserYsize.get()} )')
        header.append(f'(k40_whisperer_set LaserXscale   {self.LaserXscale.get()} )')
        header.append(f'(k40_whisperer_set LaserYscale   {self.LaserXscale.get()} )')
        header.append(f'(k40_whisperer_set LaserRscale   {self.LaserRscale.get()} )')
        header.append(f'(k40_whisperer_set rapid_feed    {self.rapid_feed.get()} )')
        header.append(f'(k40_whisperer_set gotoX         {self.gotoX.get()} )')
        header.append(f'(k40_whisperer_set gotoY         {self.gotoY.get()} )')
        header.append(f'(k40_whisperer_set bezier_M1     {self.bezier_M1.get()} )')
        header.append(f'(k40_whisperer_set bezier_M2     {self.bezier_M2.get()} )')
        header.append(f'(k40_whisperer_set bezier_weight {self.bezier_weight.get()} )')
        header.append(f'(k40_whisperer_set trace_gap     {self.trace_gap.get()} )')
        header.append(f'(k40_whisperer_set trace_speed   {self.trace_speed.get()} )')
        header.append(f'(k40_whisperer_set t_timeout     {self.t_timeout.get()} )')
        header.append(f'(k40_whisperer_set n_timeouts    {self.n_timeouts.get()} )')
        header.append(f'(k40_whisperer_set ink_timeout   {self.ink_timeout.get()} )')
        header.append(f'(k40_whisperer_set designfile    \042{self.DESIGN_FILE}\042 )')
        header.append(f'(k40_whisperer_set inkscape_path \042{self.inkscape_path.get()}\042 )')
        header.append(f'(k40_whisperer_set batch_path    \042{self.batch_path.get()}\042 )')
    ...
    def refreshTime(self):
        ...
        if self.GcodeData.ecoords == []:
            ...
            self.PreviewCanvas.create_text(
                HUD_X, HUD_Y-HUD_vspace, fill="blue", text=self.Veng_time.get(), anchor="se", tags="HUD")
    ...
    def Entry_Reng_feed_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Reng_feed,
    ...
    def Entry_Veng_feed_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Veng_feed,
    ...
    def Entry_Vcut_feed_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Vcut_feed,
    ...
    def Entry_Rstep_Check(self):
        try:
            value = get_raster_step_1000in(self.rast_step.get())
...
#############################
    ...
    def Entry_Ink_Timeout_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Ink_Timeout,
    ...
    def Entry_N_Timeouts_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_N_Timeouts,
    ...
    def Entry_N_EGV_Passes_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_N_EGV_Passes,
    ...
    def Entry_Laser_Area_Width_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Laser_Area_Width,
    ...
    def Entry_Laser_Area_Height_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Laser_Area_Height,
    ...
    def Entry_Laser_X_Scale_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Laser_X_Scale,
    ...
    def Entry_Laser_R_Scale_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Laser_R_Scale,
    ...
    def Entry_Laser_Rapid_Feed_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Laser_Rapid_Feed,
    ...
    def Entry_Reng_passes_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Reng_passes,
    ...
    def Entry_Vcut_passes_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Vcut_passes,
    ...
    def Entry_Gcde_passes_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Gcde_passes,
    ...
    def Entry_Trace_Gap_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Trace_Gap,
    ...
    def Entry_Trace_Speed_Callback(self, varName, index, mode):
        self.entry_set(self.Entry_Trace_Speed,
    ...
    def menu_Reload_Design(self, event=None):
        ...
        if (os.path.isfile(file_full)):
            ...
            self.statusMessage.set("file not found: %s" %
                                   (os.path.basename(file_full)))
            self.statusbar.configure(bg='red')
            return
    ...
    def Open_SVG(self, filemname):
        ...
        try:
            try:
                try:
                    ...
                    svg_reader.parse_svg(self.SVG_FILE)
                    svg_reader.set_size(
                        dialog_pxpi, dialog_viewbox, self.design_scale.get())
                    svg_reader.make_paths()
        ...
        ###   Create ECOORDS   ###
        ##########################
        self.VcutData.make_ecoords(
            svg_reader.cut_lines, scale=1/25.4*self.design_scale.get())
        self.VengData.make_ecoords(
            svg_reader.eng_lines, scale=1/25.4*self.design_scale.get())
            ...
            if (self.RengData.image != None and self.RengData.ecoords == []):
                ...
                for i in range(0, him, Raster_step):
                    ...
                    if (stamp != timestamp):
                        ...
                        self.statusMessage.set(
                            "Creating Scan Lines: %.1f %%" % ((100.0*i)/him))
                        self.master.update()
                    if self.stop[0] == True:
    ...
    def Open_Settings_File(self, filename):
        ...
        var_names_strings = ["include_Reng", "include_Veng", "include_Vcut", "include_Gcde",
            ...
            "ink_timeout"]
        variables = [self.include_Reng, self.include_Veng, self.include_Vcut, self.include_Gcde,
            self.include_Time, self.halftone, self.negate, self.HomeUR, self.inputCSYS, self.advanced,
            self.mirror, self.rotate, self.engraveUP, self.init_home, self.post_home, self.post_beep,
            self.post_disp, self.post_exec, self.pre_pr_crc, self.inside_first, self.comb_engrave,
            self.comb_vector, self.zoom2image, self.rotary, self.trace_w_laser, self.board_name,
            self.units, self.Reng_feed, self.Veng_feed, self.Vcut_feed, self.jog_step,
            self.Reng_passes, self.Veng_passes, self.Vcut_passes, self.Gcde_passes, self.rast_step,
            self.ht_size, self.LaserXsize, self.LaserYsize, self.LaserXscale, self.LaserYscale,
            self.LaserRscale, self.rapid_feed, self.gotoX, self.gotoY, self.bezier_M1, self.bezier_M2,
            self.bezier_weight, self.trace_gap, self.trace_speed, self.t_timeout, self.n_timeouts,
            self.ink_timeout]
        for line in fin:
            try:
                if ident in line:
                    for var_name, var in zip(var_names_strings, variables):
                        if var_name in line:
                            var.set(line[line.find(var_name):].split()[1])
                            break

                    if "designfile" in line:
                        self.DESIGN_FILE = (
                            line[line.find("designfile"):].split("\042")[1])
                    elif "inkscape_path" in line:
                        self.inkscape_path.set(
                            line[line.find("inkscape_path"):].split("\042")[1])
                    elif "batch_path" in line:
                        self.batch_path.set(
                            line[line.find("batch_path"):].split("\042")[1])
        ...
        if init_file != "None":
            if (os.path.isfile(self.DESIGN_FILE)):
                ...
                self.statusMessage.set(
                    "Image file not found: %s " % (self.DESIGN_FILE))
    ...
    def slow_jog(self, dxmils, dymils):
        ...
        Rapid_inst.make_egv_rapid(
            dxmils, dymils, Feed=Rapid_feed, board_name=self.board_name.get())
        ...
        for i in range(0, len(loops)):
            ...
            if self.LoopTree[loops[i]] != []:
                ...
                self.remove_self_references(
                    loop_numbers, self.LoopTree[loops[i]])
    ...
    def send_data(self, operation_type=None, output_filename=None):
        ...
        try:
            ...
            if (operation_type.find("Vector_Cut") > -1) and (self.VcutData.ecoords != []):
                ...
                Vcut_coords, startx, starty = self.scale_vector_coords(
                    Vcut_coords, startx, starty)
    ...
    def menu_View_Refresh_Callback(self, varName=0, index=0, mode=0):
        ...
        if DEBUG:
            ...
            print(('menu_View_Refresh_Callback called by: %s' %
                   (calframe[1][3])))
    ...
    def menu_View_Refresh(self):
        ...
        if self.units.get() == "in":
            ...
            X_display = (
                self.laserX + self.pos_offset[0]/1000.0)*self.units_scale
            Y_display = (
                self.laserY + self.pos_offset[1]/1000.0)*self.units_scale
    ...
    def menu_Help_Web(self):
        webbrowser.open_new(
            r"https://www.scorchworks.com/K40whisperer/k40whisperer.html")

    def menu_Help_Manual(self):
        webbrowser.open_new(
            r"https://www.scorchworks.com/K40whisperer/k40w_manual.html")
    ...
    def Master_Configure(self, event, update=0):
        ...
        if abs(self.w-w) > 10 or abs(self.h-h) > 10 or update == 1:
            ...
            if True:
                ...
                Yloc = 10
                self.Initialize_Button.place(
                    x=12, y=Yloc, width=100*2, height=23)
                Yloc = Yloc+33

                self.Open_Button.place(x=12, y=Yloc, width=100, height=40)
                self.Reload_Button.place(
                    x=12+100, y=Yloc, width=100, height=40)
                if h >= 560:
                    Yloc = Yloc+50
                    ...
                    self.UnLock_Button.place(
                        x=12+100, y=Yloc, width=100, height=23)

                    Yloc = Yloc+33
                    self.Label_Step.place(
                        x=x_label_L, y=Yloc, width=w_label, height=21)
                    self.Label_Step_u.place(
                        x=x_units_L, y=Yloc, width=w_units, height=21)
                    self.Entry_Step.place(
                    ...
                    bsz = 40
                    xoffst = 35
                    self.UL_Button.place(
                        x=xoffst+12,  y=Yloc, width=bsz, height=bsz)
                    self.UC_Button.place(
                        x=xoffst+12+bsz,  y=Yloc, width=bsz, height=bsz)
                    self.UR_Button.place(
                        x=xoffst+12+bsz*2,  y=Yloc, width=bsz, height=bsz)

                    Yloc = Yloc+bsz
                    self.CL_Button.place(
                        x=xoffst+12, y=Yloc, width=bsz, height=bsz)
                    self.CC_Button.place(
                        x=xoffst+12+bsz, y=Yloc, width=bsz, height=bsz)
                    self.CR_Button.place(
                        x=xoffst+12+bsz*2, y=Yloc, width=bsz, height=bsz)
                    Yloc = Yloc+bsz
                    self.LL_Button.place(
                        x=xoffst+12,  y=Yloc, width=bsz, height=bsz)
                    self.LC_Button.place(
                        x=xoffst+12+bsz,  y=Yloc, width=bsz, height=bsz)
                    self.LR_Button.place(
                        x=xoffst+12+bsz*2,  y=Yloc, width=bsz, height=bsz)
                    ...
                    Yloc = Yloc+bsz
                    ###########################################################################
                    self.Label_GoToX.place(
                        x=x_entry_L, y=Yloc, width=w_entry, height=23)
                    self.Label_GoToY.place(
                        x=x_units_L, y=Yloc, width=w_entry, height=23)
                    Yloc = Yloc+25
                    self.GoTo_Button.place(x=12, y=Yloc, width=100, height=23)
                    self.Entry_GoToX.place(
                        x=x_entry_L, y=Yloc, width=w_entry, height=23)
                    self.Entry_GoToY.place(
                        x=x_units_L, y=Yloc, width=w_entry, height=23)
                    ###########################################################################
                else:
                    ###########################################################################
                ...
                if self.GcodeData.ecoords == []:
                    ...
                    self.Entry_Vcut_feed.place(
                        x=x_entry_L, y=Yloc, width=w_entry, height=23)
                    self.Label_Vcut_feed_u.place(
                        x=x_units_L, y=Yloc, width=w_units, height=23)
                    Y_Vcut = Yloc

                    Yloc = Yloc-30
                    self.Veng_Button.place(x=12, y=Yloc, width=100, height=23)
                    self.Entry_Veng_feed.place(
                        x=x_entry_L, y=Yloc, width=w_entry, height=23)
                    self.Label_Veng_feed_u.place(
                        x=x_units_L, y=Yloc, width=w_units, height=23)
                    Y_Veng = Yloc

                    Yloc = Yloc-30
                    self.Reng_Button.place(x=12, y=Yloc, width=100, height=23)
                    self.Entry_Reng_feed.place(
                        x=x_entry_L, y=Yloc, width=w_entry, height=23)
                    self.Label_Reng_feed_u.place(
                        x=x_units_L, y=Yloc, width=w_units, height=23)
                    Y_Reng = Yloc
                ...
                if self.advanced.get():
                    ...
                    if h >= 560:
                        ...
                        adv_Yloc = adv_Yloc+25
                        self.Label_Design_Scale.place(
                            x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Entry_Design_Scale.place(
                            x=Xadvanced+w_label_adv+2, y=adv_Yloc, width=w_entry, height=23)

                        adv_Yloc = adv_Yloc+25
                        self.separator_adv3.place(
                            x=Xadvanced, y=adv_Yloc, width=wadv_use, height=2)
                    ...
                    self.Hide_Adv_Button.place(
                        x=Xadvanced, y=adv_Yloc, width=wadv_use, height=30)
                    ...
                    self.PreviewCanvas.configure(
                        width=self.w-240, height=self.h-50)
    ...
    def Plot_Data(self):
        ...
        if min((xmax-xmin), (ymax-ymin)) > 0 and self.zoom2image.get():
            self.PlotScale = max((xmax-xmin)/(cszw-buff),
                                 (ymax-ymin)/(cszh-buff))
            x_lft = minx / self.PlotScale - self.laserX / \
                self.PlotScale + (cszw-(xmax-xmin)/self.PlotScale)/2
            x_rgt = maxx / self.PlotScale - self.laserX / \
                self.PlotScale + (cszw-(xmax-xmin)/self.PlotScale)/2
            y_bot = -miny / self.PlotScale + self.laserY / \
                self.PlotScale + (cszh-(ymax-ymin)/self.PlotScale)/2
            y_top = -maxy / self.PlotScale + self.laserY / \
                self.PlotScale + (cszh-(ymax-ymin)/self.PlotScale)/2
            self.segID.append(self.PreviewCanvas.create_rectangle(
                x_lft, y_bot, x_rgt, y_top, fill="gray80", outline="gray80", width=0))
        else:
            self.PlotScale = max((maxx-minx)/(cszw-buff),
                                 (maxy-miny)/(cszh-buff))
        ...
        if self.RengData.image != None:
            if self.include_Reng.get():
                    ...
                    if new_SCALE != self.SCALE:
                        ...
                        try:
                            self.UI_image = ImageTk.PhotoImage(
                                plot_im.resize((nw, nh), Image.ANTIALIAS))
                        except:
                ...
                self.Plot_Raster(self.laserX+.001, self.laserY-.001,
        ...
        if self.include_Rpth.get() and self.RengData.ecoords != []:
            ...
            for line in self.RengData.ecoords:
                ...
                # check and see if we need to move to a new discontinuous start point
                if (loop == loop_old):
                    self.Plot_Line(xold, yold, x1, y1, x_lft, y_top,
                                   XlineShift, YlineShift, self.PlotScale, color)
                loop_old = loop
                xold = x1
                yold = y1
        ...
        if self.include_Veng.get():
            ...
            for line in plot_coords:
                ...
                if (loop == loop_old):
                    self.Plot_Line(xold, yold, x1, y1, x_lft, y_top,
                                   XlineShift, YlineShift, self.PlotScale, "blue")
                loop_old = loop
                xold = x1
                yold = y1
        ...
        if self.include_Vcut.get():
            ...
            for line in plot_coords:
                ...
                if (loop == loop_old):
                    self.Plot_Line(xold, yold, x1, y1, x_lft, y_top,
                                   XlineShift, YlineShift, self.PlotScale, "red")
                loop_old = loop
                xold = x1
                yold = y1
        ...
        if self.include_Gcde.get():
            ...
            for line in plot_coords:
                ...
                if (loop == loop_old):
                    self.Plot_Line(xold, yold, x1, y1, x_lft, y_top,
                                   XlineShift, YlineShift, self.PlotScale, "white")
                loop_old = loop
                xold = x1
                yold = y1
        ...
        if self.trace_window.winfo_exists():  # or DEBUG:
            ...
            for i in range(len(trace_coords)):
                trace_coords[i] = [trace_coords[i][0]*Xscale,
                                   trace_coords[i][1]*Yscale, trace_coords[i][2]]
        ...
        self.Plot_circle(self.laserX+xoff, self.laserY+yoff, x_lft, y_top,
                         self.PlotScale, dot_col, radius=5, cross_hair=head_offset)
    ...
    def GEN_Settings_Window(self):
        ...
        self.Checkbutton_post_home = Checkbutton(
            gen_settings, text="Unlock Rail", anchor=W)
        self.Checkbutton_post_home.place(
            x=Xoption_col1, y=D_Yloc, width=Xoption_width, height=23)
        self.Checkbutton_post_home.configure(variable=self.post_home)

        self.Checkbutton_post_beep = Checkbutton(
            gen_settings, text="Beep", anchor=W)
        self.Checkbutton_post_beep.place(
            x=Xoption_col2, y=D_Yloc, width=Xoption_width, height=23)
        self.Checkbutton_post_beep.configure(variable=self.post_beep)

        D_Yloc = D_Yloc+D_dY
        self.Checkbutton_post_disp = Checkbutton(
            gen_settings, text="Popup Report", anchor=W)
        self.Checkbutton_post_disp.place(
            x=Xoption_col1, y=D_Yloc, width=Xoption_width, height=23)
        ...
        self.Checkbutton_post_exec.place(
            x=Xoption_col2, y=D_Yloc, width=Xoption_width, height=23)
        self.Checkbutton_post_exec.configure(variable=self.post_exec)

        self.Entry_Batch_Path = Entry(gen_settings)
        self.Entry_Batch_Path.place(
            x=Xoption_col3, y=D_Yloc, width=Xoption_width, height=23)
        self.Entry_Batch_Path.configure(textvariable=self.batch_path)

        D_Yloc = D_Yloc+D_dY
        self.Label_Preprocess_CRC = Label(
            gen_settings, text="Preprocess CRC Data")
        self.Label_Preprocess_CRC.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Checkbutton_Preprocess_CRC = Checkbutton(
            gen_settings, text="", anchor=W)
        self.Checkbutton_Preprocess_CRC.place(
            x=xd_entry_L, y=D_Yloc, width=75, height=23)
        ...
        self.gen_separator1 = Frame(
            gen_settings, height=2, bd=1, relief=SUNKEN)
        self.gen_separator1.place(
            x=xd_label_L, y=D_Yloc, width=gen_width-40, height=2)

        D_Yloc = D_Yloc+D_dY*.25
        self.Label_Inkscape_title = Label(
            gen_settings, text="Inkscape Options")
        self.Label_Inkscape_title.place(
            x=xd_label_L, y=D_Yloc, width=gen_width-40, height=21)

        D_Yloc = D_Yloc+D_dY
        font_entry_width = 215
        self.Label_Inkscape_Path = Label(
            gen_settings, text="Inkscape Executable")
        self.Label_Inkscape_Path.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Entry_Inkscape_Path = Entry(gen_settings, width="15")
        self.Entry_Inkscape_Path.place(
        ...
        self.Label_Ink_Timeout.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Label_Ink_Timeout_u = Label(
            gen_settings, text="minutes", anchor=W)
        self.Label_Ink_Timeout_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units*2, height=21)
        self.Entry_Ink_Timeout = Entry(gen_settings, width="15")
        self.Entry_Ink_Timeout.place(
        ...
        self.entry_set(self.Entry_Ink_Timeout,
                       self.Entry_Ink_Timeout_Check(), 2)

        D_Yloc = D_Yloc+D_dY*1.25
        self.gen_separator2 = Frame(
            gen_settings, height=2, bd=1, relief=SUNKEN)
        self.gen_separator2.place(
            x=xd_label_L, y=D_Yloc, width=gen_width-40, height=2)

        D_Yloc = D_Yloc+D_dY*.5
        self.Label_no_com = Label(gen_settings, text="Home in Upper Right")
        self.Label_no_com.place(x=xd_label_L, y=D_Yloc,
                                width=w_label, height=21)
        ...
        D_Yloc = D_Yloc+D_dY
        self.Label_Board_Name = Label(
            gen_settings, text="Board Name", anchor=CENTER)
        self.Board_Name_OptionMenu = OptionMenu(gen_settings, self.board_name,
                                                ...
                                                "LASER-B",
                                                "LASER-A")
        self.Label_Board_Name.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Board_Name_OptionMenu.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry*3, height=23)

        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_Area_Width = Label(
            gen_settings, text="Laser Area Width")
        self.Label_Laser_Area_Width.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Label_Laser_Area_Width_u = Label(
            gen_settings, textvariable=self.units, anchor=W)
        self.Label_Laser_Area_Width_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        self.Entry_Laser_Area_Width = Entry(gen_settings, width="15")
        self.Entry_Laser_Area_Width.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        self.Entry_Laser_Area_Width.configure(textvariable=self.LaserXsize)
        self.LaserXsize.trace_variable(
            "w", self.Entry_Laser_Area_Width_Callback)
        self.entry_set(self.Entry_Laser_Area_Width,
                       self.Entry_Laser_Area_Width_Check(), 2)

        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_Area_Height = Label(
            gen_settings, text="Laser Area Height")
        self.Label_Laser_Area_Height.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Label_Laser_Area_Height_u = Label(
            gen_settings, textvariable=self.units, anchor=W)
        self.Label_Laser_Area_Height_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        self.Entry_Laser_Area_Height = Entry(gen_settings, width="15")
        self.Entry_Laser_Area_Height.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        self.Entry_Laser_Area_Height.configure(textvariable=self.LaserYsize)
        self.LaserYsize.trace_variable(
            "w", self.Entry_Laser_Area_Height_Callback)
        self.entry_set(self.Entry_Laser_Area_Height,
                       self.Entry_Laser_Area_Height_Check(), 2)

        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_X_Scale = Label(gen_settings, text="X Scale Factor")
        self.Label_Laser_X_Scale.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Entry_Laser_X_Scale = Entry(gen_settings, width="15")
        self.Entry_Laser_X_Scale.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        ...
        self.entry_set(self.Entry_Laser_Y_Scale,
                       self.Entry_Laser_Y_Scale_Check(), 2)
        ...
        self.GEN_Close.place(x=Xbut, y=Ybut, width=130,
                             height=30, anchor="center")
        self.GEN_Close.bind("<ButtonRelease-1>",
                            self.Close_Current_Window_Click)
    ...
    def RASTER_Settings_Window(self):
        ...
        D_Yloc = D_Yloc+D_dY
        self.Label_Rstep = Label(
            raster_settings, text="Scanline Step", anchor=CENTER)
        self.Label_Rstep.place(x=xd_label_L, y=D_Yloc,
                               width=w_label, height=21)
        self.Label_Rstep_u = Label(raster_settings, text="in", anchor=W)
        self.Label_Rstep_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        self.Entry_Rstep = Entry(raster_settings, width="15")
        self.Entry_Rstep.place(x=xd_entry_L, y=D_Yloc,
                               width=w_entry, height=23)
        ...
        ############
        D_Yloc = D_Yloc+D_dY
        self.Label_Halftone_DPI = Label(
            raster_settings, text="Halftone Resolution", anchor=CENTER)
        ...
        self.bezier_weight_Slider.place(
            x=xd_entry_L, y=D_Yloc, width=(Wset-xd_entry_L-25-280))
        D_Yloc = D_Yloc+21
        self.Label_bezier_weight.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        ...
        self.RASTER_Close.place(x=Xbut, y=Ybut, width=130,
                                height=30, anchor="center")
        self.RASTER_Close.bind("<ButtonRelease-1>",
                               self.Close_Current_Window_Click)
    ...
    def ROTARY_Settings_Window(self):
        ...
        self.Label_Rotary_Enable = Label(
            rotary_settings, text="Use Rotary Settings")
        self.Label_Rotary_Enable.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Checkbutton_Rotary_Enable = Checkbutton(
            rotary_settings, text="", anchor=W, command=self.Set_Input_States_Rotary)
        self.Checkbutton_Rotary_Enable.place(
            x=xd_entry_L, y=D_Yloc, width=75, height=23)
        self.Checkbutton_Rotary_Enable.configure(variable=self.rotary)

        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_R_Scale = Label(
            rotary_settings, text="Rotary Scale Factor (Y axis)")
        self.Label_Laser_R_Scale.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Entry_Laser_R_Scale = Entry(rotary_settings, width="15")
        self.Entry_Laser_R_Scale.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        ...
        self.entry_set(self.Entry_Laser_R_Scale,
                       self.Entry_Laser_R_Scale_Check(), 2)

        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_Rapid_Feed = Label(
            rotary_settings, text="Rapid Speed (default=0)")
        self.Label_Laser_Rapid_Feed.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Label_Laser_Rapid_Feed_u = Label(
            rotary_settings, textvariable=self.funits, anchor=W)
        self.Label_Laser_Rapid_Feed_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        self.Entry_Laser_Rapid_Feed = Entry(rotary_settings, width="15")
        self.Entry_Laser_Rapid_Feed.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        self.Entry_Laser_Rapid_Feed.configure(textvariable=self.rapid_feed)
        self.rapid_feed.trace_variable(
            "w", self.Entry_Laser_Rapid_Feed_Callback)
        self.entry_set(self.Entry_Laser_Rapid_Feed,
                       self.Entry_Laser_Rapid_Feed_Check(), 2)
    ...
    def TRACE_Settings_Window(self, dummy=None):
        ...
        D_Yloc = D_Yloc+D_dY
        self.Label_Laser_Trace = Label(
            trace_window, text="Laser 'On' During Trace")
        self.Label_Laser_Trace.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Checkbutton_Laser_Trace = Checkbutton(
            trace_window, text="", anchor=W)
        self.Checkbutton_Laser_Trace.place(
            x=xd_entry_L, y=D_Yloc, width=75, height=23)
        self.Checkbutton_Laser_Trace.configure(variable=self.trace_w_laser)

        D_Yloc = D_Yloc+D_dY
        self.Label_Trace_Gap = Label(
            trace_window, text="Gap Between Design and Trace")
        self.Label_Trace_Gap.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Entry_Trace_Gap = Entry(trace_window, width="15")
        self.Entry_Trace_Gap.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        self.Label_Trace_Gap_u = Label(
            trace_window, textvariable=self.units, anchor=W)
        self.Label_Trace_Gap_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        self.Entry_Trace_Gap.configure(
            textvariable=self.trace_gap, justify='center')
        ...
        self.Trace_Button.place(x=xd_label_L, y=D_Yloc,
                                width=w_label, height=23)

        self.Entry_Trace_Speed = Entry(trace_window, width="15")
        self.Entry_Trace_Speed.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        green = "#%02x%02x%02x" % (0, 200, 0)
        self.Entry_Trace_Speed.configure(
            textvariable=self.trace_speed, justify='center', fg=green)
        self.trace_speed.trace_variable("w", self.Entry_Trace_Speed_Callback)
        self.entry_set(self.Entry_Trace_Speed,
                       self.Entry_Trace_Speed_Check(), 2)
        self.Label_Trace_Speed_u = Label(
            trace_window, textvariable=self.funits, anchor=W)
        self.Label_Trace_Speed_u.place(
            x=xd_units_L, y=D_Yloc, width=w_units, height=21)
        ...
        self.Trace_Close = Button(
            trace_window, text="Cancel", command=Close_Click)
        self.Trace_Close.place(x=Xbut, y=Ybut, width=130,
                               height=30, anchor="center")
        ################################################################################
    ...
    def EGV_Send_Window(self, EGV_filename):
        ...
        self.Label_N_EGV_Passes.place(
            x=xd_label_L, y=D_Yloc, width=w_label, height=21)
        self.Entry_N_EGV_Passes = Entry(egv_send, width="15")
        self.Entry_N_EGV_Passes.place(
            x=xd_entry_L, y=D_Yloc, width=w_entry, height=23)
        ...
        self.entry_set(self.Entry_N_EGV_Passes,
                       self.Entry_N_EGV_Passes_Check(), 2)
        ...
        self.Label_Inkscape_Path = Label(
            egv_send, text=EGV_Name, anchor="w")  # ,bg="yellow")
        self.Label_Inkscape_Path.place(
            x=xd_entry_L, y=D_Yloc, width=200, height=21, anchor="nw")
        ...
        self.EGV_Close.bind("<ButtonRelease-1>",
                            self.Close_Current_Window_Click)

        def Close_and_Send_Click():
            win_id = self.grab_current()
            win_id.destroy()
            self.Open_EGV(EGV_filename, n_passes=int(
                float(self.n_egv_passes.get())))

        self.EGV_Send = Button(
            egv_send, text="Send EGV Data", command=Close_and_Send_Click)
